...
public class ConsistentHasherImpl<B extends GossipMember, M> implements ConsistentHasher<B, M> 
{
	...
	public B getBucketFor( final ByteBuffer fileId )
	{
		Preconditions.checkNotNull( fileId, "Id cannot be null" );
		
		ByteBuffer node = bucketsMap.higherKey( fileId );
		if(node == null)
			node = bucketsMap.lowerKey( fileId );
		if(node == null)
			return null;
		else
	...
	/**
	 * Returns the successor nodes of the given bucket id.
	 * 
	...
	*/
	...
	/**
	 * Returns the successor of the given id.
	 * 
	...
	*/
	...
	/**
	 * Returns the predecessor nodes of the given bucket id.
	 * 
	 * @param id	the given bucket
	*/
	...
	/**
	 * Returns the predecessor of the given bucket id.
	 * 
	 * @param id	the given bucket
	*/
	...
	/**
	 * Returns the list of virtual nodes associated to the given bucket node.
	*/
	public List<ByteBuffer> getVirtualNodesFor( final B bucketName )
	{
		Preconditions.checkNotNull( bucketName, "Bucket name can not be null" );
